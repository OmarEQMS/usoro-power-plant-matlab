...
pair suddenly faces the whole system curve. Power dips to ≈365 MW and
claws back to ≈420 — air-limited, exactly as this page predicts.
...
- **Test 6 (frequency drop):** synchronous speed itself falls 6.7%; fan
  ...
  at ≈470 MW — the fans, not the boiler, set that number.
